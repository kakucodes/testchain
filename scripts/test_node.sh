...
#
# Examples:
# CHAIN_ID="local-1" HOME_DIR="~/.rollchain" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="local-2" HOME_DIR="~/.rollchain" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export BINARY=${BINARY:-kakud}
export DENOM=${DENOM:-ukaku}
...
from_scratch () {
  ...
  # kaku1efd63aw40lxf3n4mhf7dzhjkr453axur4hjwy0
  ...
  # kaku1hj5fveer5cjtn4wd6wstzugjfdxzl0xpfrp2dx
  ...
  # poa
  update_test_genesis '.app_state["poa"]["params"]["admins"]=["kaku10d07y265gmmuvt4z0w9aw880jnsr700j4dqahk"]'
